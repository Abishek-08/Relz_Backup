...
import { confirmSurvey } from '../../../services/Services';
...
const SurveyConfirmation = () => {
  ...
  const verifyToken = async (token) => {
    try {
      const res = await confirmSurvey(token);
      setData(res.data);
      setStatus('success');
    } catch (err) {
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 max-w-lg w-full">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-semibold text-slate-900 mb-3">
            Survey already confirmed!
          </h2>
          <p className="text-slate-600 text-sm leading-relaxed mb-6">
            You’ve already confirmed your survey for this event. Thank you for participating! 🎉
          </p>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 max-w-md w-full text-center">
        <div className="mb-6">
          ...
          <h2 className="text-2xl font-semibold text-slate-900 mb-2">
            Verifying Your Survey details
          </h2>
          <p className="text-slate-600 text-sm leading-relaxed">
            Please wait while we confirm your survey...
          </p>
        </div>
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 max-w-lg w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600 text-sm leading-relaxed">
            Thank you for your valuable time. Your response has been recorded and verified.
          </p>
        </div>
            ...
            <div className="space-y-3">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-slate-900 text-md font-medium mt-1">{data?.email || 'Not provided'}</p>
                </div>
              </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-blue-800 text-sm mt-1 leading-relaxed">
                  Your response has been successfully recorded. Our team will review it and may reach out if additional information is needed.
                </p>
              </div>
            </div>
          </div>
