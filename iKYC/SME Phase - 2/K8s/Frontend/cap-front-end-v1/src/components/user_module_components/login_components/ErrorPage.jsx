...
import logo from "../../../assets/user-module-assets/CAP LOGIN DEMO.png";
/**
...
const ErrorPage = () => {
  ...
  return (
    <div className="error-page">
      ...
      <nav>
        <div className="menu">
          <img src={logo} style={{ width: "160px" }} alt="cap_logo"></img>
          <div className="menu_links">
            <a href="/cap" className="link">
              Home
            </a>
          </div>
        ...
        <div className="container">
          ...
          <div className="text">
            <article>
              ...
              <button onClick={handleBack}>i dare!</button>
            </article>
          </div>
        </div>
      </section>
