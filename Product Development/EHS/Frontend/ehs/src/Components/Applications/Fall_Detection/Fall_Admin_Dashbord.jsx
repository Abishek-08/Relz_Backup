...
import Fall_Weekly_Bar_Chart from "./Fall_Weekly_Bar_Chart";
import Fall_Acquistion_Bie_Chart from "./Fall_Acquistion_Bie_Chart";
      ...
      <div className="grid grid-cols-1 gap-6 mb-6 w-full xl:grid-cols-2 2xl:grid-cols-4">
          ...
          <div className="flex items-center">
            ...
            <div className="flex-shrink ml-3">
              <span className="text-2xl font-bold leading-none text-gray-900">
                {/* {kpiData?.ppe_compliance_rate_this_month} */} 5.5
              </span>
              <h3 className="text-base font-normal text-gray-500">
                Fall Compliance Rate this Month
              </h3>
            </div>
        ...
        <div className="bg-white shadow-lg shadow-gray-200 rounded-2xl p-4">
          <div className="flex items-center">
            ...
            <div className="flex-shrink ml-3">
              <span className="text-2xl font-bold leading-none text-gray-900">
                {/* {kpiData?.non_compliance_incidents_this_week} */} 2
              </span>
              <h3 className="text-base font-normal text-gray-500">
      ...
      <div className="grid grid-cols-1 gap-6 mb-6 w-full xl:grid-cols-2 2xl:grid-cols-4">
        <div className="bg-white shadow-lg shadow-gray-200 rounded-2xl p-4">
          <div className="flex items-center">
            ...
            <div className="flex-shrink ml-3">
              <span className="text-2xl font-bold leading-none text-gray-900">
                {/* {kpiData?.compliance_streak} */} 78.9
              </span>
              <h3 className="text-base font-normal text-gray-500">
