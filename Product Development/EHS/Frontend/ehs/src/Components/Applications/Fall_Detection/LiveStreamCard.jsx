    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div onClick={() => onEnlarge("1")} className="cursor-pointer">
          ...
          <video
            src="/src/Components/Applications/Fall_Detection/video_5.mp4"
            controls
            loop
            autoPlay
          />
        ...
        <div onClick={() => onEnlarge("2")} className="cursor-pointer">
          ...
          <video
            src="/src/Components/Applications/Fall_Detection/video_3.mp4"
            controls
            loop
            autoPlay
          />
        ...
        <div onClick={() => onEnlarge("3")} className="cursor-pointer">
          ...
          <video
            src="/src/Components/Applications/Fall_Detection/fall 1.mp4"
            controls
            loop
            autoPlay
          />
