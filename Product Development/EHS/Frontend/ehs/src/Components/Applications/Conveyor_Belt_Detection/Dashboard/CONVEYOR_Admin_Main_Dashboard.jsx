...
import CONVEYOR_Admin_Dashbord from "./CONVEYOR_Admin_Dashbord";

const CONVEYOR_Admin_Main_Dashboard = () => {
                ...
                <a className="flex items-center cursor-pointer p-2 text-gray-600 rounded-lg dark:text-white ">
                  <div className="p-2 bg-stone-500 rounded-lg shadow-lg">
                    ...
                    >
                      <path
                        fill="#f6f5f4"
                        d="M1 10v7h1a2 2 0 1 0 4 0h12a2 2 0 1 0 4 0h1v-7zm20 5h-2v-2h-2v2h-2v-2h-2v2h-2v-2H9v2H7v-2H5v2H3v-3h18z"
                      />
                    </svg>
                  </div>
                  <span className="ms-2 text-gray-900">Conveyor Belt</span>
                </a>
              </li>
              <li>
                <a
...
export default CONVEYOR_Admin_Main_Dashboard;
