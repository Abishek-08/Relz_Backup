...
const SolutionsPage = () => {
  ...
  useEffect(() => {
    ...
    getSolutionBysolutionId(industryId);
  }, []);
  ...
  const getSolutionBysolutionId = () => {
    getSolutionByIdService(industryId)
      .then((res) => {
        if (res.status === 200) {
  ...
  const handleCheckboxChange = (e) => {
    ...
    if (name === "allSelect") {
      let tempIndustry = solutionList.map((industry) => {
        selectedSolution.length === 0
          ? setSelectedSolution((prev) => [...prev, industry])
          : setSelectedSolution([]);
        return { ...industry, isChecked: checked };
      });
      setSolutionList(tempIndustry);
    } else {
      let tempIndustry = solutionList.map((industry) =>
        ...
        <div className="mb-1 w-full">
          <div className="mb-4">
              ...
              <ol className="inline-flex items-center space-x-1 md:space-x-2">
                <li className="inline-flex items-center">
                  <a
                    ...
                    className="text-base cursor-pointer font-normal inline-flex items-center text-gray-700 hover:text-gray-900"
                  >
                    <svg
            ...
            <h1 className="text-xl font-semibold text-gray-900 sm:text-2xl">
              {useSelector(
                (state) => state.adminDashSlice.industry.industryType
              )}
            </h1>
          </div>
                    ...
                    <th scope="col" className="p-4">
                      <div className="flex items-center">
                        <input
                          ...
                          checked={
                            !solutionList.some(
                              (solution) => solution?.isChecked !== true
                            )
                          }
                ...
                <tbody>
                  {slice.map((solution, index) => (
                    ...
                    >
                      <td className="w-4 p-4">
                        <div className="flex items-center">
                          <input
                            ...
                            checked={solution?.isChecked || false}
                            onChange={handleCheckboxChange}
                      ...
                      <td className="px-6 py-4">{solution.solutionType}</td>
                      ...
                      <td className="px-6 py-4 space-x-2 whitespace-nowrap">
                        ...
                        <button
                          onClick={() => deleteSolution(solution.solutionId)}
        ...
        <div className="items-center inline-flex space-x-2">
          ...
          <form className="max-w-sm mx-auto items-center">
            <select
              onChange={(e) =>
                e.target.value === "All"
                  ? setRowsPerPage(solutionList.length)
