...
import {
  getAllBundlePlanService,
  insertBundlePlanService,
} from "../../../../Services/Plan_Services/BundlePlanService";
import { getUnplannedIndustryService } from "../../../../Services/Industry_Services/IndustryService";
...
const Bundle_Plan = () => {
  ...
  const createPlan = (data) => {
    ...
    insertPlanService(plan_data)
      .then((res) => {
        bundlePlan_data.plan_Id = res.data.planId;
        console.log(bundlePlan_data);

        insertBundlePlanService(bundlePlan_data)
          .then(() => {
            reset();
            addPlanModal.hide();
            getAllPlan();
  ...
  const getUnplannedIndustry = () => {
    getUnplannedIndustryService()
      .then((res) => {
                    ...
                    <div className="sm:col-span-2">
                      ...
                      >
                        ...
                        {industryList.map((industry, index) => (
                          <option value={industry.industryId} key={index}>
